INSERT INTO coins_table (`name`, short_description, `description`, issuing_country, composition, quality, denomination, `year`, weight, price, avers_img, revers_img, coin_type, show_coin ) VALUES 
...
', 'CANADA', 'nickel', 'BU', '5 cents', 1965, 4.54, 40, '/Canadian Beaver_1.png', '/Canadian Beaver_2.png', 'Commemorative', 1),
...
', 'CANADA', 'gold', 'BU', '1 dollar', 1970, 5.4, 65, '/Looney_1.png', '/Looney_2.png', 'Commemorative', 1),
...
', 'UNITED STATES OF AMERICA', 'nickel', 'BU', '5 cents', 1966, 3.54, 35, '/Jefferson_1.png', '/Jefferson_2.png', 'Commemorative', 1),
('Kennedy', 'The unique coin is made in honor of the assassination of the 35th president of Texas.', 'On November 22, 1963, in connection with the assassination of the 35th President John F. Kennedy in Dallas (Texas), it was decided to perpetuate the memory of President Kennedy on a coin.
...
', 'UNITED STATES OF AMERICA', 'nickel', 'BU', 'HALF DOLLAR', 1963, 4.3, 43, '/Kennedy_1.png', '/Kennedy_2.png', 'Commemorative', 1),
('Canadian Cent', '"Canadian cent." A unique coin with the image of maple leaves - symbols of Canada. Face value - 1 cent.', 'On May 3, 2012, the Department of the Treasury of Canada announced the cessation of production of a 1 cent coin. The latest issues of the famous 1-cent maple leaf were minted in 2012.
...
', 'CANADA', 'Steel', 'BU', '1 cent', 1965, 2.7, 8, '/Canadian Cent_1.png', '/Canadian Cent_2.png', 'Commemorative', 1),
('A penny', '"A penny". A unique coin with a shield image with 13 vertical stripes.', 'Minted from 1793 to the present day.
...
', 'UNITED STATES OF AMERICA', 'Steel', 'BU', '1 cent', 1793, 5.1, 8, '/A penny_1.png', '/A penny_2.png', 'Commemorative', 1),
('25 cents', 'Unique coin depicting a caribou (reindeer). The face value of the coin is equal to a quarter of the Canadian dollar.', 'The obverse depicts Queen Elizabeth II. The caribou (reindeer) is depicted on the reverse.
...
', 'CANADA', 'nickel', 'BU', '25 cents', 1966, 5.7, 80, '/25 cents_1.png', '/25 cents_2.png', 'Commemorative', 1),
('Dim Sum', 'Dim Sum is a 10-cent coin of the United States that has been minted from 1946 to the present. This is a unique coin with the image of a torch, oak and olive branches.', 'The obverse of the coin depicts a portrait of the 32nd President of the United States, Franklin D. Roosevelt, and the reverse depicts a torch, oak and olive branches above the motto “E pluribus unum” - “Out of many.”
...
', 'UNITED STATES OF AMERICA', 'nickel', 'BU', '10 cents', 1946, 4.25, 10, '/Dim Sum_1.png', '/Dim Sum_2.png', 'Commemorative', 1);


INSERT INTO coins_table (`name`, short_description, `description`, issuing_country, composition, quality, denomination, `year`, weight, price, avers_img, revers_img, coin_type, show_coin ) VALUES 
('South Vietnamese Dong', 'Currency of the Republic of Vietnam in 1955-1975 Coin with the image of wheat.', 'Currency of the Republic of Vietnam in 1955-1975.
...
', 'the Republic of Vietnam', 'nickel', 'BU', '1 dong', 1955, 5.05, 56, '/South Vietnamese Dong_1.png', '/South Vietnamese Dong_2.png', 'Bullion', 1),
...
', 'British South Africa', 'gold', 'BU', '1/2 pound', 1952, 6.3, 78, '/The British Antelope_1.png', '/The British Antelope_2.png', 'Bullion', 1),
('Cron', 'A unique coin depicting a Knorr Viking ship at sea.', 'Coin 1 crown was issued from August 1, 1934 to March 25, 1941, during the first period of Estonia’s independence.
...
', 'the Belgian Congo', 'gold', 'BU', '2 francs', 1947, 5.45, 68, '/Franc_1.png', '/Franc_2.png', 'Bullion', 1),
('Stork', 'Unique coin with the image of a flying stork. French coin at 2 two francs 1997.', 'Two francs by Georges Gynemer - a commemorative coin of two French francs, issued in 1997 in honor of the famous pilot of the First World War, Georges Gynemer, on the occasion of the 80th anniversary of the officer cross of the Legion of Honor and his death: shot down in flight by a German plane.
...
', 'France', 'steel', 'BU', '2 francs', 1997, 6.57, 54, '/Stork_1.png', '/Stork_2.png', 'Bullion', 1),
('Gyeonggi', '"Gyeonggi". Coin with the image of five kangaroos - symbols of Australia.', 'The first Australian coin with a nominal value of 1 dollar was introduced on May 13, 1984 to replace a one-dollar banknote.
...
', 'Australia', 'gold', 'BU', '1 dollar', 1984, 4.76, 97, '/Gyeonggi_1.png', '/Gyeonggi_2.png', 'Bullion', 1),
('Bolivian Peso', 'Boliviano Coin with the image of Bolivia.', 'By 1987, the Bolivian peso had completely depreciated and was replaced by a new boliviano during another monetary reform.
...
', 'Bolivia', 'steel', 'BU', '1 PESO', 1988, 3.62, 54, '/Bolivian Peso_1.png', '/Bolivian Peso_2.png', 'Bullion', 1),
('Botswana', '"Botswana". Coin with the image of a bird.', 'Coin of state of Botswana 1976.
...
', 'Botswana', 'steel', 'BU', '1 thebe', 1976, 4.28, 62, '/Botswana_1.png', '/Botswana_2.png', 'Bullion', 1),
('Virginia', 'Virginia Coin with the image of a seahorse. Coin created during the reign of Elizabeth II.', 'The obverse depicts Her Majesty Queen Elizabeth II. At the top of the coin is the inscription British Virgin Islands Queen Elizabeth II 2014.
...
', 'British Virgin Islands', 'nickel', 'BU', '5 dollars', 2014, 6.98, 108, '/Virginia_1.png', '/Virginia_2.png', 'Bullion', 1),
('Theobroma Cocoa', 'Coin with a lion in the center of the shield. Ghana coin, published in 1967.', 'The reverse depicts a runaway lion in the center of a shield divided into four parts, separating the date and the face value. The inscription at the top of the coin is TWENTY
...
', 'Ghana', 'steel', 'BU', '20 pesewas', 1962, 4.76, 54, '/Theobroma Cocoa_1.png', '/Theobroma Cocoa_2.png', 'Bullion', 1),
('Coin of the Weimar Republic', 'The Hindenburg Coin with the coat of arms of the Weimar Republic.', 'On the obverse, in the center of the coin, at the top is the coat of arms of the Weimar Republic. In the center below is the coat of arms of the Hindenburg family. This is a shield divided into 4 fields - in the upper left and lower right corners there is a head of a bull.
...
', 'the Weimar Republic', 'silver', 'BU', '5 Mark', 1927, 4.76, 142, '/Coin of the Weimar Republic_1.png', '/Coin of the Weimar Republic_2.png', 'Bullion', 1),
('Scientist', 'Silver Egyptian coin with the image of the god Thoth. Silver Egyptian coin.', 'Face value one pound. It has been produced since 1981.
...
', 'Egypt', 'silver', 'BU', '1 pound', 1981, 3.95, 112, '/Scientist_1.png', '/Scientist_2.png', 'Bullion', 1);


INSERT INTO coins_table (`name`, short_description, `description`, issuing_country, composition, quality, denomination, `year`, weight, price, avers_img, revers_img, coin_type, show_coin ) VALUES 
('Lion sedge', 'Indian coin with the image of a lion Ashoka. Face value 1 one rupee. 1975 edition.', 'It depicts the lion Ashok on his pedestal. It is surrounded by the inscription of the name of the country in two languages, meaning and date, surrounded by stylized stalks of grain.
...
', 'India', 'steel', 'BU', '1 rupee', 1975, 4.95, 76, '/Lion sedge_1.png', '/Lion sedge_2.png', 'Exclusive', 1),
('Rial', 'Iranian silver coin with the image of a lion. Face value 5000 five thousand dinars (5 five taps). 1928 year.', 'It depicts a bust of Reza Shah, whose head is turned to the right.
...
', 'Iran', 'silver', 'BU', '5000 dinars', 1928, 6.12, 98, '/Rial_1.png', '/Rial_2.png', 'Exclusive', 1),
('ISK', 'Icelandic coin with a picture of a fish. Face value 1 Icelandic krona Initially, the krone consisted of 100 Eire (ISL. EYRIR, MN. CH. ISL. Aurar), but since January 1, 1995 Eire has not been used in monetary circulation.
...
', 'Iceland', 'nickel', 'BU', '1 Icelandic krona', 2007, 5.42, 78, '/ISK_1.png', '/ISK_2.png', 'Exclusive', 1),
('Yemen', 'Coin of South Arabia (Yemen) with the image of a viral boat. Coin in 25 twenty five fils.', 'An octagonal star with dots is depicted on one side of the coin.
...
', 'Yemen', 'nickel', 'BU', '25 fils', 1964, 5.47, 69, '/Yemen_1.png', '/Yemen_2.png', 'Exclusive', 1),
('Woman', '1 yuan Chinese coin with a picture of a woman. 1986 edition.', 'On one side of the coin is a woman sitting on a stone. Doves fly around her
...
', 'China', 'nickel', 'BU', '1 yuan', 1986, 6.02, 48, '/Woman_1.png', '/Woman_2.png', 'Exclusive', 1),
('Alligator', 'Chinese coin with the image of an alligator. 5 yuan Chinese coin. 1998 edition.', 'It depicts a Chinese alligator on the banks of the river.

On the other side is a Chinese weapon with stars. It is surrounded by hieroglyphs and a coin release date.
', 'China', 'nickel', 'BU', '5 yuan', 1998, 7.24, 78, '/Alligator_1.png', '/Alligator_2.png', 'Exclusive', 1),
('The Golden Panda', 'Chinese coin with the image of two pandas. 5 yuan Chinese coin. 1993 edition.', 'On one side of the coin are two pandas. At the top of the coin are Chinese characters in an arc.
...
', 'China', 'nickel', 'BU', '5 yuan', 1993, 7.24, 82, '/The Golden Panda_1.png', '/The Golden Panda_2.png', 'Exclusive', 1),
('Costa Rica', 'Costa - African coin with the image of manatee. Costa Rican coin of 100 columns. It has been produced since 1974.', 'On one side of the coin is a shield with a sailing ship in front of the mountains. Below is the release date of the coin.
...
', 'Costa Rica', 'nickel', 'BU', '100 columns', 1974, 5.24, 78, '/Costa Rica_1.png', '/Costa Rica_2.png', 'Exclusive', 1),
('Year of the children', 'Costa is an African coin depicting three chicks in a nest. Costa Rican coin of 100 columns. It has been produced since 1979.', 'On one side of the coin are 3 chicks in a nest, symbolizing the International Year of Children.
...
', 'Costa Rica', 'nickel', 'BU', '100 columns', 1979, 5.24, 72, '/Year of the children_1.png', '/Year of the children_2.png', 'Exclusive', 1),
('Sailboat', 'Portuguese silver coin with the image of a sailing ship.', 'Portuguese silver coin in 5 five escudos. It has been produced since 1933.
...
', 'Portugal', 'silver', 'BU', '5 escudos', 1933, 4.4, 134, '/Sailboat_1.png', '/Sailboat_2.png', 'Exclusive', 1);
